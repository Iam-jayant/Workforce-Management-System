...
import { ref, set, push, onValue, off } from '@react-native-firebase/database';
      ...
      try {
        const granted = await PermissionsAndroid.request(
          PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION,
          {
            ...
            message: 'WorkForce Navigator needs access to your location for tracking and navigation.',
